#ifndef EPS_GTPU_NEW_H
#define EPS_GTPU_NEW_H
 ...
 * \ingroup lte
 *
 * New Gtp header for small package combine
 *
 */
class GtpNewHeader : public Header
{
public:
  /**
   ...
   */
  //!!!
  uint8_t GetTeidHashValue() const;

  bool GetTeidFlag() const;
...
Set sequence number function
   ...
   */
  void SetTeidHashValue(uint8_t teidHashValue);

  void SetTeidFlag(bool teidFlag);
   ...
   */
  bool operator == (const GtpNewHeader& b) const;
