...
EXAMPLE_DIRECTORIES = ['ipv6', 'tutorial', 'udp-client-server', 'traffic-control', 'stats', 'socket', 'udp', 'tcp', 'routing', 'matrix-topology', 'wireless', 'error-model', 'energy', 'naming', 'realtime']
...
INCLUDES_PYEMBED = ['/root/anaconda3/include/python3.6m']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/root/anaconda3/lib/python3.6/config-3.6m-x86_64-linux-gnu', '/root/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_EXECUTABLE_PATH = ['/root/mqc/TSN/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/root/mqc/TSN/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/root/mqc/TSN/ns-allinone-3.29/ns-3.29/build/lib']
...
PYTHON_CONFIG = ['/root/anaconda3/bin/python3.6-config']
PYTHON_VERSION = '3.6'
...
cfg_files = ['/root/mqc/TSN/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/root/mqc/TSN/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
